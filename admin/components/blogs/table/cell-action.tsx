...
import { BlogPageColumn } from './column';
...
const CellAction = ({ data }: CellActionProps) => {
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.storeId}/blogs/${data.slug}`);
      router.refresh();
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => router.push(`/${params.storeId}/blogs/${data.slug}`)}>
